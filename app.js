...
form.addEventListener("submit", function(e) {
  e.preventDefault();
// parseInt makes the value ruturned an integer number value
  const value = parseInt(amount.value);
  const random = Math.floor(Math.random() * text.length);

  // checking that the value returned is an integer
// Strings are displayed in the console in BLACK text
// Numbers are displayed in the console in BLUE text
// console.log(typeof value);

// Empty value entered
// Negative number entered
// > 9
// Double pipe characters || means OR
// So: if (condition) || OR 2nd condition
